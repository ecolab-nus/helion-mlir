...
call_function  _new_var        <function _new_var at 0x7fec3b3268c0>          (arg0_1,)                                                                    {}
call_function  _new_var_1      <function _new_var at 0x7fec3b3268c0>          (arg1_1,)                                                                    {}
call_function  _new_var_2      <function _new_var at 0x7fec3b3268c0>          (arg2_1,)                                                                    {}
call_function  _new_var_3      <function _new_var at 0x7fec3b3268c0>          (arg3_1,)                                                                    {}
call_function  _new_var_4      <function _new_var at 0x7fec3b3268c0>          (arg4_1,)                                                                    {}
call_function  k_view          <function _host_tensor at 0x7fec3b325000>      ('k_view',)                                                                  {}
call_function  sym_size_int    aten.sym_size.int                              (arg0_1, 0)                                                                  {}
call_function  block_size_3    <function _get_symnode at 0x7fec3b3243a0>      ('block_size_3',)                                                            {}
call_function  load            <function load at 0x7fec2c898b80>              (k_view, [sym_size_int, slice(None, None, None), block_size_3], None, None)  {}
call_function  k               <function set_memory_space at 0x7fec2c618a60>  (load, 1)                                                                    {}
call_function  sym_size_int_1  aten.sym_size.int                              (arg0_1, 1)                                                                  {}
call_function  _mask_to_1      <function _mask_to at 0x7fec3b326560>          (k, 0)                                                                       {}
call_function  qk              aten.bmm.default                               (_new_var, _mask_to_1)                                                       {}
call_function  _mask_to_2      <function _mask_to at 0x7fec3b326560>          (qk, -inf)                                                                   {}
...
call_function  m_ij_broad      <function broadcast at 0x7fec2c6184c0>         (m_ij, 2, [sym_size_int, sym_size_int_1, block_size_3])                      {}
...
call_function  _mask_to_3      <function _mask_to at 0x7fec3b326560>          (exp, 0)                                                                     {}
...
call_function  v_view          <function _host_tensor at 0x7fec3b325000>      ('v_view',)                                                                  {}
call_function  v               <function load at 0x7fec2c898b80>              (v_view, [sym_size_int, block_size_3, slice(None, None, None)], None, None)  {}
call_function  acc_1           aten.baddbmm.default                           (acc, _mask_to_3, v)                                                         {}
call_function  m_i             <function _new_var at 0x7fec3b3268c0>          (m_ij,)                                                                      {}
output         output          output                                         ([m_i, l_i, acc_1],)                                                         {}
Graph 1: RootGraphInfo
opcode         name           target                                     args                                                                         kwargs
-------------  -------------  -----------------------------------------  ---------------------------------------------------------------------------  ----------------------------------------------------------------------------------------------------
call_function  qk_scale_dev   <function full at 0x7fec2c8783a0>          ([], 0.08838834764831843, torch.float16, None)                               {}
call_function  block_size_0   <function _get_symnode at 0x7fec3b3243a0>  ('block_size_0',)                                                            {}
call_function  block_size_1   <function _get_symnode at 0x7fec3b3243a0>  ('block_size_1',)                                                            {}
call_function  m_i            <function full at 0x7fec2c8783a0>          ([block_size_0, block_size_1, 1], -inf, torch.float16, None)                 {}
...
call_function  acc            <function full at 0x7fec2c8783a0>          ([block_size_0, block_size_1, 128], 0.0, torch.float16, None)                {}
call_function  q_view         <function _host_tensor at 0x7fec3b325000>  ('q_view',)                                                                  {}
call_function  q              <function load at 0x7fec2c898b80>          (q_view, [block_size_0, block_size_1, slice(None, None, None)], None, None)  {}
call_function  k_in_size1     <function _get_symnode at 0x7fec3b3243a0>  ('k_in_size1',)                                                              {}
call_function  _for_loop      <function _for_loop at 0x7fec3b325360>     (0, [0], [k_in_size1], [q, m_i, qk_scale_dev, l_i, acc])                     {}
...
call_function  _phi           <function _phi at 0x7fec3b325870>          (m_i, getitem)                                                               {}
call_function  _phi_1         <function _phi at 0x7fec3b325870>          (l_i, getitem_1)                                                             {}
call_function  _phi_2         <function _phi at 0x7fec3b325870>          (acc, getitem_2)                                                             {}
call_function  l_i_broadcast  <function broadcast at 0x7fec2c6184c0>     (_phi_1, 2, [block_size_0, block_size_1, 128])                               {}
call_function  acc_1          aten.div.Tensor                            (_phi_2, l_i_broadcast)                                                      {}
call_function  out_           <function _host_tensor at 0x7fec3b325000>  ('out_',)                                                                    {}
call_function  store          <function store at 0x7fec2c898160>         (out_, [block_size_0, block_size_1, slice(None, None, None)], acc_1, None)   {}
...
Node load : FakeTensor(..., size=(u4, 128, u7), dtype=torch.float16)
Node k : FakeTensor(..., size=(u4, 128, u7), dtype=torch.float16)
Node sym_size_int_1 : u5
Node _mask_to_1 : FakeTensor(..., size=(u4, 128, u7), dtype=torch.float16)
  ...
  func.func @attention(%k_view_arg: memref<32x128x4096xf16>, %v_view_arg: memref<32x4096x128xf16>, %q_view_arg: memref<32x4096x128xf16>, %out__arg: memref<32x4096x128xf16>) {
    ...
    affine.parallel (%arg4, %arg5) = (0, 0) to (symbol(%3), symbol(%4)) {
      ...
      %14:3 = scf.for %arg6 = %c0 to %13 step %c1 iter_args(%arg7 = %6, %arg8 = %7, %arg9 = %9) -> (tensor<?x?x1xf16>, tensor<?x?x1xf16>, tensor<?x?x128xf16>) {
        ...
        %19 = bufferization.to_tensor %subview_4 : memref<?x128x?xf16, strided<[524288, 4096, 1], offset: ?>> to tensor<?x128x?xf16, 1 : i64>
        ...
        %24 = linalg.batch_matmul ins(%12, %19 : tensor<?x?x128xf16>, tensor<?x128x?xf16, 1 : i64>) outs(%23 : tensor<?x?x?xf16>) -> tensor<?x?x?xf16>
